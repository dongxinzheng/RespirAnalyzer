/*
 * The Implementation of MultiFractal Detrended Fluctuation Analysis in C++.
 *
 * In order to improve the processing speed of large data, we developed the C++ implementation of MFDFA.
 * The references are as follows:
 *
 * 1. MFDFA: an R package computes the multifractal detrended fluctuation analysis for a time series.
 * https://CRAN.R-project.org/package=MFDFA
 * Published:	2019-04-15
 * Author:	Mohamed Laib [aut, cre], Luciano Telesca [aut], Mikhail Kanevski [aut]
 * License:	GPL-3
 *
 * 2. C function 'polyfit': Simple least-squares polynomial fit routine written in C.
